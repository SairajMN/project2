...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as proid,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid,orders.orderStatus as status from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
$cnt=1;
...
?>
				<tr>
					...
					<td>
						...
						if($status=="" || $status=="Packed" || $status=="Dispatched" || $status=="In Transit" || $status=="Pending") {
						?>
							<br/><a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Cancel order" style="color:red;">
							Cancel</a>
						<?php 
						} elseif($status=='Cancelled') {
							echo "<br/><span style='color:red;'>Cancelled</span>";
						}
						?>
					</td>
				</tr>
